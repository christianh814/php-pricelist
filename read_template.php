...
echo "<div class='overflow-hidden'>";
	...
	echo "<button class='btn btn-danger pull-right margin-bottom-1em margin-right-1em' id='delete-selected'>";
		echo "<span class='glyphicon glyphicon-remove-circle'></span> Delete Selected";
	echo "</button>";
